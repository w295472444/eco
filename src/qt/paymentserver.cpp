...
const QString BITCOIN_IPC_PREFIX("Ecologicalsquare:");
...
{
    QString name("EcologicalsquareQt");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Ecologicalsquare: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Ecologicalsquare: click-to-pay handler");
    else
...
{
    // clicking on Ecologicalsquare: URLs creates FileOpen events on the Mac:
